...
<head>
  ...
  <!-- Stylesheets
	============================================= -->
  <?php wp_head(); // tells the wordpress where to enqueue the styles ?>
...
<body <?php body_class( 'stretched no-transition' ); // loads additional classes in the body tag dinamically (used by addons...) ?>>

...
function recipe_init(){
    ...
    // define configurations labels of the new post type will show in admin menu
    $labels = array(
    ...
    // define configurations about the new post type
    $args = array(
        'labels'                =>  $labels,
    ...
    // register the new post type to be called in a add_action hook
    // the register_post_type must be called just in 'init' hook of wordpress to work properly
